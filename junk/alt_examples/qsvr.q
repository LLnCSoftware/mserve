...
.z.ps:{[req] /0N!req ;
  ...
  fn: (value `.api) ex 0 ;                   /get function given its name at index 0 of the parsed query/
  if[null fn; :.z.w (req 0; 0N!"Error: unknown command: ", string ex 0)];   /reject anything else
  .z.w (req 0; @[fn; ex 1; {[e] 0N!"Error: ",(string ex 0), " ", e}]);      /invoke function on argument at index 1 of parsed query
