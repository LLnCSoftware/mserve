...
badsymbol: `VOD ;   /throw exception when this symbol received to demo error handling and failover
...
.api.proc1:{[s]do[100;
    if[badsymbol in s; '"BadSymbol ", (string badsymbol), " received (testing error handling)."] ;
